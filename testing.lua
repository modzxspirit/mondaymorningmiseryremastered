...
local ScrollType = function(Side)
  repeat wait() until FakeContainer(Side)and #FakeContainer(Side):children()>1
...
local Initialize = function(Side)
    ...
    repeat wait()until #Arrows:WaitForChild'Notes':children()>1
    repeat wait()until FakeContainer(Side)and Arrows.Notes and #Arrows.Notes:children()>1
